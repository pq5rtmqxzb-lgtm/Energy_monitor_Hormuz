...
const PRELOADED_GEO = {
  ...
  events: [
    { title: "Houthis enter the war \u2014 fire missiles at Israel", impact: "bullish", detail: "Houthis launched ballistic missiles at Israeli military sites on March 28, their first attack of the Iran war. Houthi deputy info minister: 'Closing Bab al-Mandeb is among our options.' Al Jazeera calls Bab el-Mandeb their 'ace card.'" },
    ...
    { title: "Dubai physical crude at $126 \u2014 paper vs physical divergence", impact: "bullish", detail: "Dubai physical crude (actual deliveries) at $126/bbl vs Brent futures at $112.57. JPMorgan warns: 'If the Strait does not reopen, this divergence is unlikely to persist' \u2014 meaning futures must reprice higher." },
    { title: "Iran allows 20 Pakistani ships through Hormuz", impact: "bearish", detail: "Pakistan secured deal for 20 vessels (2/day) to transit Hormuz. Pakistan FM called it 'a harbinger of peace.' Modest volume but signals Iran's willingness to negotiate access bilaterally." },
    { title: "USS Tripoli + 3,500 Marines arrive in Middle East", impact: "bullish", detail: "Pentagon weighing deployment options including possible seizure of Iran's Kharg Island \u2014 source of most Iranian oil exports. Would represent major escalation." },
    { title: "Trump extends Hormuz deadline to April 6", impact: "neutral", detail: "Extended strike deadline by 10 days. Claims talks going 'very well'; Iran denies negotiations. Trump called it 'Strait of Trump.' 15-point plan reportedly on the table." },
  ],
  sentiment: "bullish",
};
...
const PRELOADED_SCENARIOS = {
  bull: {
    narrative: "The 'double chokepoint' scenario materializes: Houthis execute their declared 'Hour Zero' and close the Bab el-Mandeb Strait, cutting off Saudi Arabia's last viable export route via the Red Sea port of Yanbu. With both Hormuz and Bab el-Mandeb closed, roughly 24-25M bbl/day of oil flows are disrupted. With short-run demand elasticity of ~-0.05 (Hamilton 2009), a 15% supply deficit implies prices must rise ~300% from the pre-crisis $85 base. Macquarie's $200/bbl estimate may prove conservative.",
    ...
    supply_impacts: [
      ...
      { event: "Strait of Hormuz closed (since Mar 2)", impact: "-17.8M bbl/day", detail: "Iran's yuan toll system blocks ~18% of global supply. Only ~33 vessels transited via Iran's Larak Island toll in late March. Iran allowed 20 Pakistani ships (2/day) as diplomatic gesture." },
      { event: "Houthis close Bab el-Mandeb", impact: "-6.5M bbl/day", detail: "Saudi Yanbu pipeline exports become unreachable for Asian buyers. ~30 tankers near Yanbu within Houthi strike range. Container shipping already paused (Maersk, Hapag-Lloyd, CMA CGM)." },
      ...
      { event: "Saudi East-West pipeline (Abqaiq to Yanbu)", impact: "+7.0M bbl/day capacity", detail: "Bloomberg (March 28): pipeline now at full 7M bbl/day capacity. Yanbu crude exports at 5M bbl/day + 700-900K bbl/day products. However, if Bab el-Mandeb closes, all maritime exports from Yanbu are stranded." },
      { event: "Saudi Yanbu export viability", impact: "-6.5M bbl/day (negated)", detail: "Bab el-Mandeb closure renders all Yanbu maritime exports undeliverable to Asian buyers (75% of Saudi exports). Only ~0.5M bbl/day viable via overland to Jordan/Egypt." },
      ...
      { event: "Hormuz toll system (Chinese/Russian vessels)", impact: "+2.5M bbl/day", detail: "Iran's Larak Island toll allows allied-flag vessels through at $1-2M/vessel. Chinese and Russian tankers carry Gulf crude under bilateral arrangements." },
      { event: "UAE pipeline to Fujairah (bypasses Hormuz)", impact: "+1.5M bbl/day", detail: "ADCOP pipeline moves Abu Dhabi crude to Fujairah on Gulf of Oman. Tankers load on Indian Ocean side." },
      ...
      { event: "U.S. SPR emergency release", impact: "+1.0M bbl/day (temporary)", detail: "Strategic Petroleum Reserve at ~350M barrels. Sustained release of ~1M bbl/day realistic. Buys 6-12 months." },
      ...
      { section: "net", label: "Net Structural Deficit", impact: "-15.8M bbl/day", detail: "This is a catastrophic, unprecedented deficit. No combination of mitigations can fully offset the simultaneous closure of both straits. Physical shortages begin in Asia within 2-3 weeks." },
    ],
    net_supply_impact: "Effective deficit: ~15.8M bbl/day. Even aggressive mitigation covers only ~36% of gross disruptions. Physical shortages inevitable within 4-6 weeks.",
    price_reasoning: "Historical precedent: the 1973 embargo removed ~7% of supply and caused a 300% price increase ($3 to $12). A 15% deficit is 2x worse. With short-run demand elasticity of ~-0.05, destroying 15% of demand via price alone requires a ~300% increase from pre-crisis $85 base, implying ~$340/bbl. Even at -0.10 elasticity, the math yields ~$210/bbl. Panic buying, sovereign hoarding, and no historical parallel further amplify price discovery. $200/bbl is a floor, not a ceiling.",
    price_target: "Brent: $200-350+ | WTI: $180-320+",
    etf_impacts: {
      IOGP: { direction: "up", reasoning: "Pure E&P exposure with ~1.2x observed beta to Brent. Operating leverage is convex: at $200+ Brent, margins expand 3.6x+ from pre-crisis (breakeven ~$40, margin goes $45 to $160+). Target: EUR55-90+ (70-180%+ upside)." },
      XLE: { direction: "up", reasoning: "Integrated majors (XOM, CVX) see record cash flows from both upstream margins and downstream refining spreads widening on product scarcity." },
      ...
      USO: { direction: "up", reasoning: "Direct WTI exposure. At $180-320+ WTI, USO could see 50-150%+ upside from current levels. Backwardation deepens." },
      BNO: { direction: "up", reasoning: "Brent at $200-350+ makes BNO the single highest-beta play. Elasticity math: 15% deficit / 0.05 demand elasticity = 300% price increase from $85 base. No historical precedent caps the upside." },
    },
    triggers: ["Houthi Bab el-Mandeb strike on shipping", "Iran signals Houthis to activate", "Saudi Yanbu exports become unreachable", "U.S. SPR emergency drawdown announced", "Physical crude premiums widen further"],
    timeframe: "1-3 months",
  },

  base: {
    narrative: "Hormuz remains closed but Houthis limit actions to missile strikes on Israel \u2014 they hold Bab el-Mandeb as an 'ace card' per Al Jazeera, not yet deploying it. Saudi Arabia's East-West pipeline at full 7M bbl/day capacity (Bloomberg, March 28) partially offsets Gulf disruption via Yanbu, with 5M bbl/day crude exports flowing through the Red Sea. Diplomatic channels show fragile progress: Pakistan secures transit for 20 ships, Trump's April 6 deadline creates a forcing function.",
    outlook: "bullish",
    probability: 50,
    supply_baseline: "Global production: ~104M bbl/day | Global demand: ~103M bbl/day | Buffer: ~1M bbl/day",
    supply_impacts: [
      { section: "disruptions", label: "Supply Disruptions" },
      { event: "Strait of Hormuz partially reopens", impact: "-8.0M bbl/day", detail: "Iran's toll system continues but allows more vessels. Partial transit resumes at $1-2M/vessel fees. Down from -17.8M at peak." },
      { event: "Bab el-Mandeb under threat but open", impact: "-1.0M bbl/day", detail: "Houthi threats cause ~30% traffic reduction. Maersk/Hapag-Lloyd pause Trans-Suez but tankers still transit with elevated insurance." },
      ...
      { event: "Iranian toll transit volume", impact: "+2.0M bbl/day", detail: "Chinese/Russian-flagged vessels continue transiting Hormuz via Iran's Larak Island toll system." },
      { section: "mitigations_total", label: "Total Effective Mitigation", impact: "+9.0M bbl/day", detail: "Sum of: Saudi pipeline (+5.0), UAE pipeline (+1.5), non-OPEC (+0.5), Iranian toll transit (+2.0). Bloomberg's confirmation of 7M bbl/day Saudi pipeline capacity materially improves the base case." },
      { section: "net", label: "Net Structural Deficit", impact: "-0.3M bbl/day", detail: "Near-balanced market if Bab el-Mandeb stays open and Hormuz partially reopens. Saudi pipeline is the critical swing factor. However, this equilibrium is fragile." },
    ],
    ...
    price_reasoning: "A 0.3M bbl/day deficit is only ~0.3% of global consumption. But the market prices risk, not just current flows. With Houthis now active and Bab el-Mandeb closure explicitly 'among their options,' futures embed a significant risk premium. The Dubai physical-to-Brent gap ($126 vs $112.57) shows the physical market is already tighter than futures suggest.",
    price_target: "Brent: $95-115 | WTI: $88-105",
    etf_impacts: {
      IOGP: { direction: "up", reasoning: "At $95-115 Brent, E&P constituents see margins of $55-75/bbl (breakeven ~$40). With 1.2x observed beta and hedges rolling off H2, IOGP consolidates at EUR30-38." },
      ...
      USO: { direction: "flat", reasoning: "WTI range-bound at $88-105. Physical market tight (Dubai $126) supports prices, but Trump's jawboning dampens futures." },
  ...
  bear: {
    narrative: "Ceasefire reached by mid-April via Pakistan-mediated talks (Islamabad hosting Saudi, Turkish, Egyptian FMs). Iran reopens Hormuz fully; Houthis stand down. However, this scenario became less likely on March 28: Houthis' entry, Iran's continued defiance, and USS Tripoli troop deployment all point toward escalation rather than resolution. Demand destruction from weeks of $100+ oil shows up in Asian import data.",
    outlook: "bearish",
    probability: 20,
    ...
    supply_impacts: [
      ...
      { event: "Hormuz reopening transition period", impact: "-2.0M bbl/day", detail: "Full commercial transit takes 2-4 weeks to normalize. Insurance rates remain elevated during transition. Backlog of ~60 tankers clears gradually." },
      ...
      { event: "Iraq resumes production", impact: "+0.5M bbl/day restored", detail: "Force majeure lifted on foreign-operated fields." },
      ...
      { event: "OPEC+ oversupply risk", impact: "+0.5M bbl/day excess", detail: "Returning Gulf production + weakened demand = surplus. OPEC+ delays planned increases." },
    ...
    net_supply_impact: "Net: market flips to ~2M bbl/day oversupply. Inventory builds accelerate. Contango returns.",
    price_reasoning: "The $14-18/bbl risk premium (Goldman) unwinds fully, returning Brent to pre-crisis ~$75-85. But prices typically overshoot: the 1991 Gulf War resolution saw oil drop 30% below pre-crisis levels within months as panic-hoarded inventory flooded back. A 2M bbl/day surplus with demand destruction lag creates contango that punishes long positions. Post-crisis trough could briefly touch $65 before stabilizing around $70-80.",
    price_target: "Brent: $65-80 | WTI: $60-75",
    etf_impacts: {
      IOGP: { direction: "down", reasoning: "E&P margins compress from $72/bbl (at $112 Brent) to $25-40/bbl at $65-80. With 1.2x beta, IOGP gives back 20-30%. Hedges provide some downside protection in H1. Target: EUR20-26." },
      ...
      VDE: { direction: "down", reasoning: "Broader sell-off hits mid/small-cap energy hardest. VDE's wider basket amplifies downside." },
...
const HOUTHI_ASSESSMENT = {
  ...
  thesis: "Houthis have entered the Iran war (March 28) and explicitly stated that closing the Bab el-Mandeb Strait is 'among our options.' The question is no longer if, but when.",
  probability: "45-55% within next 14 days (upgraded from 35-40%)",
  evidence: [
    "CONFIRMED: Houthis fired ballistic missiles at Israel on March 28 (Al Jazeera, CNN, Time)",
    "Houthi deputy info minister: 'We are conducting this battle in stages, and closing the Bab al-Mandeb strait is among our options'",
    "Houthi military spokesperson declared attacks 'will continue until the aggression against all fronts of the resistance ceases'",
    "Al Jazeera correspondent describes Bab el-Mandeb as the Houthis' 'ace card' for economic warfare against Israel",
    "Houthi 'red lines' include: US using Red Sea for attacks on Iran, escalating attacks on Iran, broader country participation",
    "Maersk, Hapag-Lloyd, CMA CGM already paused all Trans-Suez sailings",
    "Saudi Yanbu exports now at 5M bbl/day (Bloomberg) \u2014 all within Houthi strike range",
    "USS Gerald Ford in Crete for repairs \u2014 sending it back to Red Sea risks 2024-style attacks",
    "Axios: Houthis have not yet used their 'nuclear option' of closing Bab el-Mandeb \u2014 but all preconditions are now met",
  ],
  impact: "If executed: ~6-7M bbl/day additional disruption. Saudi Arabia's 5M bbl/day Yanbu exports become undeliverable. Combined with Hormuz closure, net deficit reaches ~15.8M bbl/day after mitigations. Elasticity math (15% deficit / 0.05 demand elasticity) implies Brent $250-350+. Physical market (Dubai at $126) already pricing ahead of paper futures ($112.57).",
};
...
const IOGP_ANALYSIS = {
  ...
  sections: [
    { label: "Observed beta (YTD 2026)", detail: "Brent rose ~33% from ~$85 pre-crisis to $112.57. IOGP rose ~40% over the same period (from ~EUR23 to EUR32.20). This implies an observed equity beta to oil of approximately 1.2x. Consistent with academic E&P literature (typically 1.2-1.8x for pure upstream)." },
    { label: "Operating leverage mechanism", detail: "E&P companies have high fixed costs and variable revenue. If breakeven is ~$40/bbl, margin at $85 Brent is $45. At $200, margin is $160 (3.6x increase from 2.4x price move = 1.5x leverage). At $300, margin is $260 (5.8x from 3.5x = 1.65x leverage). The relationship is non-linear and convex \u2014 the higher oil goes, the MORE leveraged E&P earnings become." },
    { label: "Hedging dilution (near-term dampener)", detail: "Most E&P companies hedge 30-60% of production 12-18 months forward. At current prices, much of 2026 production was hedged at $70-85. Near-term realized prices lag spot. But as hedges roll off in H2 2026, full spot price flows to earnings. Source: RBN Energy analysis." },
    { label: "Scenario-specific IOGP targets", detail: "Bull ($200-350 Brent): IOGP margin leverage of 1.5-1.7x, plus multiple expansion. IOGP could reach EUR55-90+ (70-180% upside). | Base ($95-115 Brent): consolidates at EUR28-36. | Bear ($65-80 Brent): retraces to EUR20-25 (25-35% downside)." },
    { label: "Key risk: Gulf-exposed producers", detail: "IOGP's index includes global E&P companies, some with Gulf-exposed production. In a double-chokepoint scenario, Gulf producers may see production curtailed even as prices spike. Non-Gulf producers (U.S. shale, Canadian oil sands, Brazilian pre-salt) would benefit most." },
  ],
};
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
          ...
          <div className="divide-y divide-gray-800">
            {etfs.map(etf => { const d = market.etfs[etf.ticker]; return (
              <div key={etf.ticker} className="px-4 py-3 flex items-center justify-between hover:bg-gray-800 transition-colors group">
                ...
                <div className="flex items-center gap-4"><div className="text-right"><p className="text-sm font-semibold">{d ? `${d.currency === "EUR" ? "\u20ac" : "$"}${d.price.toFixed(2)}` : <span className="text-gray-600">\u2014</span>}</p>{d && <PctBadge val={d.change_pct} />}</div>{!etf.primary && (<button onClick={() => removeEtf(etf.ticker)} className="opacity-0 group-hover:opacity-100 text-gray-600 hover:text-red-400 transition-all"><X size={14} /></button>)}</div>
              </div>); })}
          </div>
        </div>
        <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
        ...
        <div className="bg-red-950/30 border border-red-900 rounded-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-red-900/50 flex items-center gap-2"><AlertTriangle size={16} className="text-red-400" /><h2 className="text-sm font-semibold text-red-300">{HOUTHI_ASSESSMENT.title}</h2><span className="ml-auto text-xs px-2 py-0.5 rounded font-medium bg-red-900 text-red-300">P: {HOUTHI_ASSESSMENT.probability}</span></div>
          <div className="p-4 space-y-3"><p className="text-sm text-gray-300"><strong className="text-red-300">Thesis:</strong> {HOUTHI_ASSESSMENT.thesis}</p><div><h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Supporting Evidence</h4><div className="space-y-1">{HOUTHI_ASSESSMENT.evidence.map((e, i) => (<div key={i} className="flex items-start gap-2 text-xs text-gray-400"><span className="text-red-400 mt-0.5 shrink-0">\u2022</span><span>{e}</span></div>))}</div></div><div className="bg-red-950/50 rounded-xl p-3"><p className="text-xs text-red-300"><strong>Impact if triggered:</strong> {HOUTHI_ASSESSMENT.impact}</p></div></div>
        </div>

        <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-800 flex items-center gap-2"><Target size={16} className="text-purple-400" /><h2 className="text-sm font-semibold">Scenario Analysis</h2></div>
