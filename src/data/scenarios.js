...
export const SCENARIOS = {
  bull: {
    ...
    triggers: [
      ...
      "IRGC kinetic activity / strikes — IRGC Navy Larak exercise this weekend telegraphs continued control",
      "Lebanon-Israel Washington talks: adjourned without deal Saturday, resume next week — collapse on resumption is the live trigger",
      "Trump-Xi readout cleared without Iran deliverable — bullish overlay already partially priced; watch for follow-through statements",
  ...
  base: {
    ...
    triggers: [
      "Trump-Xi joint readout (Sat): Iran in boilerplate, no Chinese commitment on Iranian crude — bullish for the position; watch for follow-through MFA/WH clarifications this week",
      "IOGP.AS open Monday 09:00 CET — first clean read on how Amsterdam digests the IEA OMR and Beijing readout in one session",
      "Lebanon-Israel Washington talks resume next week after Saturday's adjournment without deal",
      "Iranian / IRGC response to Chinese preferential transit (IRGC Navy Larak exercise this weekend)",
